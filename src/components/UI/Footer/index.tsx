...
// import loylo_club_footer_logo from '../../../../public/svgs/raft_footer_logo.svg';
...
const Footer = () => {
  return (
    <Wrapper>
      <Inner>
        <FooterLogo>
          {/* <Image src={loylo_club_footer_logo} alt="Loylo.club logo" /> */}
          <span>Loylo.club</span>
        </FooterLogo>
        <FooterMainContent>
          <FooterMiddle>
            <QRContainer>
          ...
          <FooterBottom>
            ...
            <CopyRight>
              ...
              © 2025 Loylo.club — Connecting loyalty across communities.
            </CopyRight>
          </FooterBottom>
        </FooterMainContent>
      </Inner>
